...
FROM mcr.microsoft.com/java/jdk:8-zulu-debian10 as job-analyzer-webservice
...
COPY "webservice/build/libs/proactive-job-analyzer-webservice-${SDL_JOB_ANALYZER_VERSION}.jar" "/sdl/proactive-job-analyzer-webservice.jar"
ENTRYPOINT ["java", "-jar", "/sdl/proactive-job-analyzer-webservice.jar"]
